 ...
 * - cache-busting dla thumb/edit/print (żeby nowe pliki były widoczne od razu)
 * ============================================================
 */
...
/**
 * Cache-busting:
 * Zmień wartość CACHE_VERSION, gdy podmieniasz miniatury/overlaye/printy,
 * a przeglądarka nadal pokazuje stare pliki.
 */
const CACHE_VERSION = "2026-02-06-01";
function withV(url) {
